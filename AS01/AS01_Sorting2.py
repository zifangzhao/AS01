    ...
    def ProcessData(self, path):
        ...
        if self.run_greenlight == 1:
            ...
            if platform == "linux" or platform == "linux2":
                ...
                cmd = 'start "Running Spike Sorting:' + path + '" cmd /c "C:\%HOMEPATH%\\anaconda3\\Scripts\\activate.bat&conda activate phy2&cd ' + path + '&klusta process.prm --legacy-output --overwrite & del AS01.state"'
            # print(cmd)
            os.system(cmd)
